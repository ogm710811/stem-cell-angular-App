...
export class MedicalInfoFormComponent implements OnInit {
  // using ViewChild allows to reset the form ones the
  // user click the submit button
  @ViewChild('medicalInfoForm') medicalInfoForm: NgForm;
  ...
  displayInfo() {
    console.log(`USER AT MEDICAL INFO COMPONENT => ${ this.theUser.getFullName() }`);
  }
